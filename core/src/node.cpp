...
public:
    ...
    std::unordered_map<int, PendingSubInfo> pending_sub_infos;
    std::unordered_map<int, SubInfo> sub_infos;
    ...
    void spin() {
        ...
        while (true) {
            ...
            for (int i = 0; i < event_num; ++i) {
                ...
                else if (sub_infos.find(active_fd) != sub_infos.end()) {
                    char buffer[4096] = {0};
